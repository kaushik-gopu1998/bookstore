...
public class CartController {
	...
	public ResponseEntity<String> addProductToCart(@PathVariable("userId") Integer userId,@RequestBody AddToCartVO addToCartVO) throws UserIdNotFoundException, ProductNotFoundException, QuantityOverFlowException{
	...
	@PutMapping("/edit")
	public ResponseEntity<String> updateCartItem(@RequestBody CartQuantityUpdateVO cartDetails) throws CartItemNotExistsException, QuantityOverFlowException{
		cartService.editCartDetails(cartDetails);
